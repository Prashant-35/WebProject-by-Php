...
<div class="mx-5 mt-5 text-center">
    <p class="bg-primary text-white p-2"> Send Issue Book Request </p>
</div>
    ...
    <div class="col-md-4 mb-3">
      ...
      <div class="valid-tooltip">
        Looks good!
            ...
            <button class="btn btn-primary" type="submit" name="submit2">Send Request</button>
</form>
        </div>
    </body>
</html>
...
if(isset($_POST['submit2'])){
    ...
    $Insert = "INSERT INTO issuebook VALUES('$_SESSION[login]','$bookname','$authorname','','','')";
    ...
    if($resq){
     ?>
         <script>
             alert("Book request is sucessfully send");
         </script>
     <?php
    }
 else{
