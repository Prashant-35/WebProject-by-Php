...
<div class="mx-5 mt-5 text-center">
    <div  style="margin-bottom: 1%; margin-left: 450px;">
        ...
        <form class="form-inline my-2 my-lg-0" action="" method="POST">
            ...
            <button class="btn btn-primary my-2 my-sm-0" type="submit" name="submit" style="margin-top: 10%;" >Issue Book</button>
...
if(isset($_SESSION['login_user']))
	{
		$sql = "SELECT new.email,book.bookname FROM new inner join issuebook ON new.email=issuebook.username inner join book ON issuebook.bookname=book.bookname WHERE issuebook.approve = ''";
