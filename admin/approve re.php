...
<div class="mx-5 mt-5 text-center">
  ...
  if(isset($_POST['submit4']))
  {
    ...
    mysqli_query($conn,"UPDATE  `returnbook` SET  `approve` =  '$_POST[approve]', `issue` =  '$_POST[issue]', `return` =  '$_POST[return]' WHERE username='$_SESSION[name]' and bookname='$_SESSION[bkname]';");
    ...
    ?>
      <script type="text/javascript">
        ...
        window.location="returnrequest.php";
      </script>
    <?php
  }
?>
